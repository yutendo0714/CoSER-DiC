# 20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon

Date: 2026-06-27T22:29:50

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage1_semantic_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_lpips002_rateprior001_tau01_freezecodebook_ft500.pt --eval-protocol coser_common_lic --batch-size 4 --num-workers 4 --compute-perceptual --codec fixed_bits --write-per-image-metrics --save-reconstructions --wandb-mode offline --run-name 20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon
```
...
- fixed_bits_psnr_mean: 20.02974978360263
- fixed_bits_l1_mean: 0.07493717623027889
- fixed_bits_ms_ssim_mean: 0.6186410867806637
- fixed_bits_token_roundtrip_mean: 1.0
- fixed_bits_lpips_alex_mean: 0.723928681964224
- fixed_bits_dists_mean: 0.4381402236042601
- fixed_bits_all_tokens_roundtrip: True

## Artifacts

- summary: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon/summary.json`
- output_dir: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon`
- streams: ``
- reconstructions: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon/reconstructions`
- per_image_metrics: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior001_tau01_freezecodebook_ft500_coser_common_lic_perimage_recon/per_image_metrics.jsonl`
