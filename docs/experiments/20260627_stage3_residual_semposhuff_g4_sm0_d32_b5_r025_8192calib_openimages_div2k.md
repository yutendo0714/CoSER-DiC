# 20260627_stage3_residual_semposhuff_g4_sm0_d32_b5_r025_8192calib_openimages_div2k

Date: 2026-06-27T14:31:24

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/fit_stage3_residual_huffman_prior.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt --image-root /dpl/open-images-v6/train/data --image-root /dpl/div2k --crop-size 256 --max-images 8192 --batch-size 16 --num-workers 8 --detail-downsample-factor 32 --detail-bits 5 --detail-range 0.25 --coding-mode semantic_position_huffman --semantic-group-count 4 --semantic-group-iters 25 --smoothing-count 0 --wandb-mode offline --run-name 20260627_stage3_residual_semposhuff_g4_sm0_d32_b5_r025_8192calib_openimages_div2k
```

## Summary

- checkpoint: checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt
- prior: outputs/stage3_residual_entropy/20260627_stage3_residual_semposhuff_g4_sm0_d32_b5_r025_8192calib_openimages_div2k/static_residual_grid_semantic_position_huffman_prior.json
- num_images: 8192
- crop_size: 256
...
- mean_huffman_bits_per_symbol: 2.8553899129231772
...
- prior: `outputs/stage3_residual_entropy/20260627_stage3_residual_semposhuff_g4_sm0_d32_b5_r025_8192calib_openimages_div2k/static_residual_grid_semantic_position_huffman_prior.json`
- summary: `outputs/stage3_residual_entropy/20260627_stage3_residual_semposhuff_g4_sm0_d32_b5_r025_8192calib_openimages_div2k/summary.json`
