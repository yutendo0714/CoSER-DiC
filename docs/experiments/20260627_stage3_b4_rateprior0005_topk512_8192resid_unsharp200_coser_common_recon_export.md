...
Date: 2026-06-27T23:21:14

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage3_uniform_residual_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_lpips002_rateprior0005_tau01_vq005_freezecodebook_ft500.pt --semantic-prior outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_4096tokens_stage1_rateprior0005_tau01_vq005_ft500_lowlr3k/learned_topk_escape_huffman_prior.json --token-prior-checkpoint checkpoints/stage2_token_prior/20260627_stage2_token_prior_tf256_l4_3kstep_4096tokens_stage1_rateprior0005_tau01_vq005_ft500_lr1e4_do02_es.pt --eval-protocol coser_common_lic --crop-size 256 --batch-size 8 --num-workers 4 --detail-downsample-factor 32 --detail-bits 4 --detail-range 0.25 --detail-codec semantic_position_leftctx_huffman --detail-prior outputs/stage3_residual_entropy/20260627_stage3_residual_semposleft_g4_sm0_d32_b4_r025_8192calib_stage1_rateprior0005_tau01_vq005_ft500/static_residual_grid_semantic_position_leftctx_huffman_prior.json --stream-header-codec compact --stream-checksum-codec crc32 --decoder-postprocess unsharp3x3 --decoder-postprocess-strength 2.0 --compute-perceptual --save-reconstructions --wandb-mode offline --run-name 20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export
```
...
- semantic_payload_bpp_mean: 0.012372011126893939
- detail_payload_bpp_mean: 0.0052209102746212125
- actual_payload_bpp_mean: 0.017592921401515152
- paper_bpp_mean: 0.017592921401515152
- total_payload_bpp_mean: 0.017592921401515152
- debug_semantic_only_full_stream_bpp_mean: 0.01713275331439394
- debug_full_stream_bpp_mean: 0.026870265151515152
- semantic_only_full_stream_bpp_mean: 0.01713275331439394
- stage3_full_stream_bpp_mean: 0.026870265151515152
- semantic_payload_bytes_mean: 101.35151515151514
- detail_payload_bytes_mean: 42.76969696969697
- stage3_stream_bytes_mean: 220.12121212121212
- semantic_only_psnr_mean: 20.858660345366506
- semantic_only_l1_mean: 0.06748875356420422
- semantic_only_ms_ssim_mean: 0.6911498600786382
- stage3_psnr_mean: 21.187341557127056
- stage3_l1_mean: 0.06550027527987505
- stage3_ms_ssim_mean: 0.6940290635282343
- semantic_topk_hit_rate_mean: 0.3858901515151515
- semantic_token_roundtrip_mean: 1.0
- detail_code_roundtrip_mean: 1.0
- residual_grid_abs_mean_mean: 0.02117983465167609
- residual_grid_std_mean: 0.025605426062688685
- residual_grid_clip_ratio_mean: 0.0
- detail_code_entropy_bits_mean: 1.68544286223072
- semantic_only_lpips_alex_mean: 0.6151976212181828
- semantic_only_dists_mean: 0.38711830485950816
- stage3_lpips_alex_mean: 0.5847526681016791
- stage3_dists_mean: 0.37226816632530907
- stage3_psnr_delta_vs_semantic_only: 0.32868121176055
- stage3_l1_delta_vs_semantic_only: -0.001988478284329173
- stage3_ms_ssim_delta_vs_semantic_only: 0.002879203449596135
- stage3_lpips_alex_delta_vs_semantic_only: -0.030444953116503637
- stage3_dists_delta_vs_semantic_only: -0.014850138534199087
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/per_image_metrics.jsonl
- reconstruction_manifest: results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/reconstructions/manifest.jsonl
- reconstruction_count: 165
- reconstruction_dirs: {'reference': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/reconstructions/reference', 'semantic_only': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/reconstructions/semantic_only', 'stage3': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/reconstructions/stage3'}

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/stage3_uniform_residual_grid.png`
- reconstruction_manifest: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_rateprior0005_topk512_8192resid_unsharp200_coser_common_recon_export/reconstructions/manifest.jsonl`
