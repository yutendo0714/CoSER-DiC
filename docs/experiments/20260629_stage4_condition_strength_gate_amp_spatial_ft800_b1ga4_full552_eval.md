# 20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4_full552_eval

Date: 2026-06-29T13:45:33

## Command

```bash
scripts/eval_stage4_cod_lite_adapter.py --checkpoint checkpoints/stage4_cod_lite_adapter/20260629_stage4_detailfilm_detailcontrast_hf_ft800_b8.pt --condition-gate-checkpoint checkpoints/stage4_cod_lite_condition_gate/20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4.pt --manifest results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/reconstructions/manifest.jsonl --per-image-metrics results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_detailcontrast_hf_ft800_b8_full552_eval/per_image_metrics.jsonl --run-name 20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4_full552_eval --crop-size 512 --batch-size 4 --num-workers 4 --blend-alpha 1.0 --wandb-mode offline
```
...
- stage4_psnr_mean: 21.13256195317144
- stage3_ms_ssim_mean: 0.7348250424138446
- stage4_ms_ssim_mean: 0.7123005351294642
- stage3_lpips_alex_mean: 0.5757592567850066
- stage4_lpips_alex_mean: 0.3963052938233359
- stage3_dists_mean: 0.3536208531130915
- stage4_dists_mean: 0.27116313587496244
- stage4_l1_mean: 0.06040831603467518
- stage3_l1_mean: 0.05592005335442398
- condition_l1_mean: 0.4130503852730212
- pre_control_condition_l1_mean: 0.4130503852730212
- control_condition_l1_delta_mean: 0.0
- ungated_condition_l1_mean: 0.41075177091187326
- base_condition_l1_mean: 0.53720763368883
- condition_l1_delta_vs_base_mean: -0.12415724841580875
- condition_residual_l1_mean: 0.4052838126494401
...
- condition_gate_mean_mean: 1.137368651403897
- count: 552
- stage4_psnr_win_rate: 0.021739130434782608
- stage4_ms_ssim_win_rate: 0.08152173913043478
- stage4_lpips_win_rate: 0.9909420289855072
- stage4_dists_win_rate: 0.9945652173913043
- stage4_blend_alpha: 1.0
- stage4_alpha_min: 1.0
- stage4_alpha_max: 1.0
- stage4_alpha_std: 0.0
- stage4_gate_checkpoint: 
- stage4_condition_gate_checkpoint: checkpoints/stage4_cod_lite_condition_gate/20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4.pt
...
- summary: `results/stage4_cod_lite_adapter_eval/20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4_full552_eval/summary.json`
- per_image: `results/stage4_cod_lite_adapter_eval/20260629_stage4_condition_strength_gate_amp_spatial_ft800_b1ga4_full552_eval/per_image_metrics.jsonl`
- reconstructions: ``
- wandb: `/workspace/CoSER-DiC/wandb/offline-run-20260629_134449-ay08bxhh`
