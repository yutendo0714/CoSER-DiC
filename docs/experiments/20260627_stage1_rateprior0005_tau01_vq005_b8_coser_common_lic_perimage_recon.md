# 20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon

Date: 2026-06-27T23:39:00

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage1_semantic_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_lpips002_rateprior0005_tau01_vq005_freezecodebook_ft500_b8.pt --eval-protocol coser_common_lic --batch-size 8 --num-workers 4 --compute-perceptual --codec fixed_bits --write-per-image-metrics --save-reconstructions --wandb-mode offline --run-name 20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon
```
...
- fixed_bits_psnr_mean: 20.85930278662479
- fixed_bits_l1_mean: 0.06753930129449476
- fixed_bits_ms_ssim_mean: 0.6907013288049987
- fixed_bits_token_roundtrip_mean: 1.0
- fixed_bits_lpips_alex_mean: 0.6125734604443565
- fixed_bits_dists_mean: 0.3863121314482255
- fixed_bits_all_tokens_roundtrip: True

## Artifacts

- summary: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon/summary.json`
- output_dir: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon`
- streams: ``
- reconstructions: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon/reconstructions`
- per_image_metrics: `results/bitstreams/stage1_semantic_vq/20260627_stage1_rateprior0005_tau01_vq005_b8_coser_common_lic_perimage_recon/per_image_metrics.jsonl`
