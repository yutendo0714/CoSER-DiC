# 20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_limit64_eval

Date: 2026-06-29T12:09:04

## Command

```bash
scripts/eval_stage4_cod_lite_adapter.py --checkpoint checkpoints/stage4_cod_lite_adapter/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8.pt --manifest results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/reconstructions/manifest.jsonl --per-image-metrics results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_ft1200_b12_limit64_eval/per_image_metrics.jsonl --run-name 20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_limit64_eval --crop-size 512 --limit 64 --batch-size 4 --num-workers 4 --wandb-mode offline
```
...
- stage4_psnr_mean: 21.544954255223274
- stage3_ms_ssim_mean: 0.7568007968366146
- stage4_ms_ssim_mean: 0.7391247898340225
- stage3_lpips_alex_mean: 0.5449693585978821
- stage4_lpips_alex_mean: 0.39956104193697684
- stage3_dists_mean: 0.3497471623122692
- stage4_dists_mean: 0.2857871623709798
- stage4_l1_mean: 0.05549479695037007
- stage3_l1_mean: 0.05090900359209627
- condition_l1_mean: 0.4109531957656145
...
- condition_l1_delta_vs_base_mean: -0.1178049142472446
- condition_residual_l1_mean: 0.3429092885926366
...
- summary: `results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_limit64_eval/summary.json`
- per_image: `results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_limit64_eval/per_image_metrics.jsonl`
- reconstructions: ``
- wandb: `/workspace/CoSER-DiC/wandb/offline-run-20260629_120858-iz1sdmve`
