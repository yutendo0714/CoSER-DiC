# 20260629_stage4_condition_strength_gate_balanced_spatial_ft800_b2ga2_limit64_eval

Date: 2026-06-29T13:53:01

## Command

```bash
scripts/eval_stage4_cod_lite_adapter.py --checkpoint checkpoints/stage4_cod_lite_adapter/20260629_stage4_detailfilm_detailcontrast_hf_ft800_b8.pt --condition-gate-checkpoint checkpoints/stage4_cod_lite_condition_gate/20260629_stage4_condition_strength_gate_balanced_spatial_ft800_b2ga2.pt --manifest results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/reconstructions/manifest.jsonl --per-image-metrics results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_detailcontrast_hf_ft800_b8_limit64_eval/per_image_metrics.jsonl --run-name 20260629_stage4_condition_strength_gate_balanced_spatial_ft800_b2ga2_limit64_eval --crop-size 512 --limit 64 --batch-size 4 --num-workers 4 --blend-alpha 1.0 --wandb-mode offline
```
...
- stage4_psnr_mean: 21.597516521811485
- stage3_ms_ssim_mean: 0.7568007968366146
- stage4_ms_ssim_mean: 0.7385801915079355
- stage3_lpips_alex_mean: 0.5449693585978821
- stage4_lpips_alex_mean: 0.3883867448894307
- stage3_dists_mean: 0.3497471623122692
- stage4_dists_mean: 0.277100938372314
- stage4_l1_mean: 0.05509790875657927
- stage3_l1_mean: 0.05090900359209627
- condition_l1_mean: 0.41173636307939887
- pre_control_condition_l1_mean: 0.41173636307939887
...
- condition_l1_delta_vs_base_mean: -0.11702174693346024
- condition_residual_l1_mean: 0.36711687315255404
...
- condition_gate_mean_mean: 1.047938585281372
- count: 64
...
- summary: `results/stage4_cod_lite_adapter_eval/20260629_stage4_condition_strength_gate_balanced_spatial_ft800_b2ga2_limit64_eval/summary.json`
- per_image: `results/stage4_cod_lite_adapter_eval/20260629_stage4_condition_strength_gate_balanced_spatial_ft800_b2ga2_limit64_eval/per_image_metrics.jsonl`
- reconstructions: ``
- wandb: `/workspace/CoSER-DiC/wandb/offline-run-20260629_135254-snqq34ds`
