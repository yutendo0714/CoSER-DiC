...
- decoder_postprocess_strength: 0.1
...
- semantic_payload_bpp_mean: 0.009204864501953125
- detail_payload_bpp_mean: 0.004756927490234375
- actual_payload_bpp_mean: 0.0139617919921875
- paper_bpp_mean: 0.0139617919921875
- total_payload_bpp_mean: 0.0139617919921875
- debug_semantic_only_full_stream_bpp_mean: 0.023670196533203125
- debug_full_stream_bpp_mean: 0.0293731689453125
- semantic_only_full_stream_bpp_mean: 0.023670196533203125
- stage3_full_stream_bpp_mean: 0.0293731689453125
- semantic_payload_bytes_mean: 301.625
- detail_payload_bytes_mean: 155.875
- stage3_stream_bytes_mean: 962.5
- semantic_only_psnr_mean: 21.49481177330017
- semantic_only_l1_mean: 0.056237666052766144
- semantic_only_ms_ssim_mean: 0.7239684537053108
- stage3_psnr_mean: 21.841897428035736
- stage3_l1_mean: 0.05356695374939591
- stage3_ms_ssim_mean: 0.7286283448338509
- semantic_topk_hit_rate_mean: 0.9248046875
- semantic_token_roundtrip_mean: 1.0
- detail_code_roundtrip_mean: 1.0
- residual_grid_abs_mean_mean: 0.018065114389173687
- residual_grid_std_mean: 0.02324525170843117
- residual_grid_clip_ratio_mean: 0.0
- detail_code_entropy_bits_mean: 1.6008022241294384
- semantic_only_lpips_alex_mean: 0.625940365716815
- semantic_only_dists_mean: 0.3728638309985399
- stage3_lpips_alex_mean: 0.624839298427105
- stage3_dists_mean: 0.3687565363943577
- stage3_psnr_delta_vs_semantic_only: 0.3470856547355652
- stage3_l1_delta_vs_semantic_only: -0.0026707123033702374
- stage3_ms_ssim_delta_vs_semantic_only: 0.004659891128540039
- stage3_lpips_alex_delta_vs_semantic_only: -0.0011010672897100449
- stage3_dists_delta_vs_semantic_only: -0.004107294604182243
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260628_stage3_b16_topk2048_gencodec512_unsharp100_batch16_smoke32/per_image_metrics.jsonl

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260628_stage3_b16_topk2048_gencodec512_unsharp100_batch16_smoke32/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260628_stage3_b16_topk2048_gencodec512_unsharp100_batch16_smoke32/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260628_stage3_b16_topk2048_gencodec512_unsharp100_batch16_smoke32/stage3_uniform_residual_grid.png`
