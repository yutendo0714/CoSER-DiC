...
- stage4_psnr_mean: 22.2306067943573
- stage4_l1_mean: 0.05193872070958605
- stage4_ms_ssim_mean: 0.7652133926749229
- stage4_refiner_residual_abs_mean_mean: 0.007490399260859704
- stage4_lpips_alex_mean: 0.41338798159267753
- stage4_dists_mean: 0.3105635056272149
...
- stage4_psnr_delta_vs_stage3: -0.15063776075839996
- stage4_l1_delta_vs_stage3: 0.0009648771738284267
- stage4_ms_ssim_delta_vs_stage3: -0.0077569447457790375
- stage4_lpips_alex_delta_vs_stage3: -0.08486423367867246
- stage4_dists_delta_vs_stage3: -0.025629726238548756
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/per_image_metrics.jsonl
- reconstruction_manifest: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/manifest.jsonl
- reconstruction_count: 64
- reconstruction_dirs: {'reference': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/reference', 'semantic_only': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/semantic_only', 'stage3': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/stage3', 'stage4': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/stage4'}

## Analysis Notes

- paper_bpp / actual_payload_bpp: 0.013593197
- roundtrip_failure_count: 0
- Stage4 delta vs Stage3: PSNR -0.150638, MS-SSIM -0.007757, LPIPS -0.084864, DISTS -0.025630
- per-image wins: LPIPS 57/64, DISTS 55/64, PSNR 0/64, MS-SSIM 1/64
- CoD-style CLIC patch-FID, torchmetrics, patch128, split2: Stage3 174.378281, Stage4 186.570114
- Interpretation: LPIPS/DISTS improve at unchanged payload bpp, but CLIC patch-FID regresses. Treat this checkpoint as over-aggressive unless an earlier checkpoint or stronger guard fixes the distribution regression.

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/stage3_uniform_residual_grid.png`
- reconstruction_manifest: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ms2k_bs4_midguard_oi_only_clic64_eval/reconstructions/manifest.jsonl`
