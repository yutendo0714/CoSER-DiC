...
Date: 2026-06-29T12:12:21

## Command

```bash
scripts/eval_stage4_cod_lite_adapter.py --checkpoint checkpoints/stage4_cod_lite_adapter/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8.pt --manifest results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/reconstructions/manifest.jsonl --per-image-metrics results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_ft1200_b12_full552_eval/per_image_metrics.jsonl --run-name 20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_full552_eval --crop-size 512 --batch-size 4 --num-workers 4 --wandb-mode offline
```
...
- stage4_psnr_mean: 21.155441614164822
- stage3_ms_ssim_mean: 0.7348250424138446
- stage4_ms_ssim_mean: 0.7158678404689915
- stage3_lpips_alex_mean: 0.5757592567850066
- stage4_lpips_alex_mean: 0.4198292040137871
- stage3_dists_mean: 0.3536208531130915
- stage4_dists_mean: 0.2875332663888517
- stage4_l1_mean: 0.06017212317311677
- stage3_l1_mean: 0.05592005335442398
- condition_l1_mean: 0.40992601923104643
- pre_control_condition_l1_mean: 0.40992601923104643
- control_condition_l1_delta_mean: 0.0
- ungated_condition_l1_mean: 0.40992601923104643
- base_condition_l1_mean: 0.53720763368883
- condition_l1_delta_vs_base_mean: -0.1272816144577835
- condition_residual_l1_mean: 0.34690408586807875
- condition_delta_raw_l1_mean: 0.5632030255012754
...
- stage4_dists_win_rate: 0.9873188405797102
...
- summary: `results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_full552_eval/summary.json`
- per_image: `results/stage4_cod_lite_adapter_eval/20260629_stage4_detailfilm_stats_hf_dists_ft1000_b8_full552_eval/per_image_metrics.jsonl`
- reconstructions: ``
- wandb: `/workspace/CoSER-DiC/wandb/offline-run-20260629_121137-05mb15an`
