...
- stage4_psnr_mean: 21.513135592142742
- stage4_l1_mean: 0.05524921572456757
- stage4_ms_ssim_mean: 0.7190478071570396
- stage4_refiner_residual_abs_mean_mean: 0.0041265869804192334
- stage4_lpips_alex_mean: 0.5414803872505823
- stage4_dists_mean: 0.35355369249979657
...
- stage4_psnr_delta_vs_stage3: -0.049467404683429805
- stage4_l1_delta_vs_stage3: 0.0003330882949133668
- stage4_ms_ssim_delta_vs_stage3: -0.0025322486956914636
- stage4_lpips_alex_delta_vs_stage3: -0.0923777619997661
- stage4_dists_delta_vs_stage3: -0.021813799937566103
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/per_image_metrics.jsonl
- reconstruction_manifest: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/manifest.jsonl
- reconstruction_count: 24
- reconstruction_dirs: {'reference': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/reference', 'semantic_only': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/semantic_only', 'stage3': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/stage3', 'stage4': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/stage4', 'triptych': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/triptych'}

## Analysis Notes

- paper_bpp / actual_payload_bpp: 0.014120738
- roundtrip_failure_count: 0
- Stage4 delta vs Stage3: PSNR -0.049467, MS-SSIM -0.002532, LPIPS -0.092378, DISTS -0.021814
- per-image wins: LPIPS 24/24, DISTS 23/24, PSNR 0/24, MS-SSIM 1/24
- CoD-style Kodak patch-FID, torchmetrics, patch64, split2: Stage3 215.036469, Stage4 177.938614
- Interpretation: confirms the step500 checkpoint selected by CLIC64 screening. It substantially improves Kodak patch-FID and LPIPS/DISTS at unchanged payload bpp with a smaller fidelity drop than the 2k checkpoint.

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/stage3_uniform_residual_grid.png`
- reconstruction_manifest: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_kodak24_eval/reconstructions/manifest.jsonl`
