# 20260627_stage3_uniform_residual_d16_b4_r025_zlib_kodak_eval

Date: 2026-06-27T11:33:08

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage3_uniform_residual_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt --semantic-prior outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_32768tokens_8kprior/learned_topk_escape_huffman_prior.json --image-root /dpl/kodak --max-images 24 --batch-size 4 --num-workers 4 --detail-downsample-factor 16 --detail-bits 4 --detail-range 0.25 --detail-codec zlib_fixed_bits --wandb-mode offline --run-name 20260627_stage3_uniform_residual_d16_b4_r025_zlib_kodak_eval
```
...
- detail_payload_bpp_mean: 0.0312042236328125
- total_payload_bpp_mean: 0.041926066080729164
- semantic_only_full_stream_bpp_mean: 0.07080586751302083
- stage3_full_stream_bpp_mean: 0.10371907552083333
- semantic_payload_bytes_mean: 87.83333333333333
- detail_payload_bytes_mean: 255.625
- stage3_stream_bytes_mean: 849.6666666666666
...
- stage3_psnr_mean: 21.60061001777649
- stage3_l1_mean: 0.05785864327723781
- stage3_ms_ssim_mean: 0.7105815907319387
- semantic_topk_hit_rate_mean: 0.6217447916666666
- semantic_token_roundtrip_mean: 1.0
- detail_code_roundtrip_mean: 1.0
- stage3_psnr_delta_vs_semantic_only: 0.864357630411785
- stage3_l1_delta_vs_semantic_only: -0.007225321140140302
- stage3_ms_ssim_delta_vs_semantic_only: 0.03481312592824304
...
- summary: `results/bitstreams/stage3_uniform_residual/20260627_stage3_uniform_residual_d16_b4_r025_zlib_kodak_eval/summary.json`
- sample: `results/bitstreams/stage3_uniform_residual/20260627_stage3_uniform_residual_d16_b4_r025_zlib_kodak_eval/stage3_uniform_residual_grid.png`
