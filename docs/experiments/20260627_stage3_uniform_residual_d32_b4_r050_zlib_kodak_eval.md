# 20260627_stage3_uniform_residual_d32_b4_r050_zlib_kodak_eval

Date: 2026-06-27T11:31:14

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage3_uniform_residual_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt --semantic-prior outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_32768tokens_8kprior/learned_topk_escape_huffman_prior.json --image-root /dpl/kodak --max-images 24 --batch-size 4 --num-workers 4 --detail-downsample-factor 32 --detail-bits 4 --detail-range 0.5 --detail-codec zlib_fixed_bits --wandb-mode offline --run-name 20260627_stage3_uniform_residual_d32_b4_r050_zlib_kodak_eval
```
...
- detail_payload_bpp_mean: 0.006947835286458333
- total_payload_bpp_mean: 0.017669677734375
- semantic_only_full_stream_bpp_mean: 0.07080586751302083
- stage3_full_stream_bpp_mean: 0.07909647623697917
- semantic_payload_bytes_mean: 87.83333333333333
- detail_payload_bytes_mean: 56.916666666666664
- stage3_stream_bytes_mean: 647.9583333333334
...
- summary: `results/bitstreams/stage3_uniform_residual/20260627_stage3_uniform_residual_d32_b4_r050_zlib_kodak_eval/summary.json`
- sample: `results/bitstreams/stage3_uniform_residual/20260627_stage3_uniform_residual_d32_b4_r050_zlib_kodak_eval/stage3_uniform_residual_grid.png`
