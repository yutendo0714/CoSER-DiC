...
- stage4_psnr_mean: 22.309318587183952
- stage4_l1_mean: 0.05133202613797039
- stage4_ms_ssim_mean: 0.7702460577711463
- stage4_refiner_residual_abs_mean_mean: 0.003910665798684931
- stage4_lpips_alex_mean: 0.44154113536933437
- stage4_dists_mean: 0.31907500699162483
...
- stage4_psnr_delta_vs_stage3: -0.07192596793174744
- stage4_l1_delta_vs_stage3: 0.0003581826022127643
- stage4_ms_ssim_delta_vs_stage3: -0.002724279649555683
- stage4_lpips_alex_delta_vs_stage3: -0.056711079902015626
- stage4_dists_delta_vs_stage3: -0.017118224874138832
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/per_image_metrics.jsonl
- reconstruction_manifest: results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/manifest.jsonl
- reconstruction_count: 64
- reconstruction_dirs: {'reference': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/reference', 'semantic_only': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/semantic_only', 'stage3': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/stage3', 'stage4': 'results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/stage4'}

## Analysis Notes

- paper_bpp / actual_payload_bpp: 0.013593197
- roundtrip_failure_count: 0
- Stage4 delta vs Stage3: PSNR -0.071926, MS-SSIM -0.002724, LPIPS -0.056711, DISTS -0.017118
- per-image wins: LPIPS 62/64, DISTS 56/64, PSNR 0/64, MS-SSIM 1/64
- CoD-style CLIC patch-FID, torchmetrics, patch128, split2: Stage3 174.378281, Stage4 172.581406
- Interpretation: best CLIC64 checkpoint in the ckpt250 sweep. It is the first Stage-4 refiner candidate in this sweep that improves both LPIPS/DISTS and CLIC patch-FID at unchanged payload bpp.

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/stage3_uniform_residual_grid.png`
- reconstruction_manifest: `results/bitstreams/stage3_uniform_residual/20260628_stage4_decoder_refiner_ckpt250sweep_step500_clic64_eval/reconstructions/manifest.jsonl`
