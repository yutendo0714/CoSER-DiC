# 20260629_stage5_detailfilm_lora_h256_guarded_denoiser_tail_r4_lr2em05_ft800_limit64_eval

Date: 2026-06-29T10:37:24

## Command

```bash
scripts/eval_stage4_cod_lite_adapter.py --checkpoint checkpoints/stage4_cod_lite_adapter/20260629_stage5_detailfilm_lora_h256_guarded_denoiser_tail_r4_lr2em05_ft800.pt --manifest results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/reconstructions/manifest.jsonl --per-image-metrics results/bitstreams/stage3_uniform_residual/20260628_stage3_gencodec512_full552_feature_cache/per_image_metrics.jsonl --run-name 20260629_stage5_detailfilm_lora_h256_guarded_denoiser_tail_r4_lr2em05_ft800_limit64_eval --output-dir results/stage4_cod_lite_adapter_eval --crop-size 512 --limit 64 --batch-size 4 --num-workers 4 --wandb-mode offline
```
...
- stage4_psnr_mean: 22.296716630458832
- stage3_ms_ssim_mean: 0.7568007968366146
- stage4_ms_ssim_mean: 0.7586247213184834
- stage3_lpips_alex_mean: 0.5449693585978821
- stage4_lpips_alex_mean: 0.4444527022424154
- stage3_dists_mean: 0.3497471623122692
- stage4_dists_mean: 0.3254500152543187
- stage4_l1_mean: 0.051181618706323206
- stage3_l1_mean: 0.05090900359209627
- condition_l1_mean: 0.4373002937063575
- pre_control_condition_l1_mean: 0.4373002937063575
- control_condition_l1_delta_mean: 0.0
- ungated_condition_l1_mean: 0.4373002937063575
- base_condition_l1_mean: 0.5809020544402301
- condition_l1_delta_vs_base_mean: -0.14360176073387265
- condition_residual_l1_mean: 0.3391108615323901
- condition_delta_raw_l1_mean: 0.5281392908655107
...
- count: 64
- stage4_psnr_win_rate: 0.203125
- stage4_ms_ssim_win_rate: 0.5625
- stage4_lpips_win_rate: 1.0
- stage4_dists_win_rate: 0.859375
...
- summary: `results/stage4_cod_lite_adapter_eval/20260629_stage5_detailfilm_lora_h256_guarded_denoiser_tail_r4_lr2em05_ft800_limit64_eval/summary.json`
- per_image: `results/stage4_cod_lite_adapter_eval/20260629_stage5_detailfilm_lora_h256_guarded_denoiser_tail_r4_lr2em05_ft800_limit64_eval/per_image_metrics.jsonl`
- reconstructions: ``
- wandb: `/workspace/CoSER-DiC/wandb/offline-run-20260629_103717-jlg4f76r`
