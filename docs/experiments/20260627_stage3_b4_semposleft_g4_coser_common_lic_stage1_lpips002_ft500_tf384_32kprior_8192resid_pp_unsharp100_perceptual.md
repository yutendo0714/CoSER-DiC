# 20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual

Date: 2026-06-27T19:52:37

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage3_uniform_residual_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_active5k_lpips002_fp32loss_ft500.pt --semantic-prior outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_32768tokens_stage1_lpips002_ft500_tf384_l6_12k/learned_topk_escape_huffman_prior.json --token-prior-checkpoint checkpoints/stage2_token_prior/20260627_stage2_token_prior_tf384_l6_12kstep_32768tokens_stage1_lpips002_ft500_lr1e4_do02_es.pt --detail-prior outputs/stage3_residual_entropy/20260627_stage3_residual_semposleft_g4_sm0_d32_b4_r025_8192calib_stage1_lpips002_ft500/static_residual_grid_semantic_position_leftctx_huffman_prior.json --eval-protocol coser_common_lic --detail-codec semantic_position_leftctx_huffman --detail-downsample-factor 32 --detail-bits 4 --detail-range 0.25 --decoder-postprocess unsharp3x3 --decoder-postprocess-strength 1.0 --stream-header-codec compact --stream-checksum-codec crc32 --compute-perceptual --wandb-mode offline --run-name 20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual
```

## Summary

- checkpoint: checkpoints/stage1_semantic_vq/20260627_stage1_active5k_lpips002_fp32loss_ft500.pt
- semantic_prior: outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_32768tokens_stage1_lpips002_ft500_tf384_l6_12k/learned_topk_escape_huffman_prior.json
...
- semantic_payload_bpp_mean: 0.010856859611742424
- detail_payload_bpp_mean: 0.005223129734848485
- actual_payload_bpp_mean: 0.016079989346590908
- paper_bpp_mean: 0.016079989346590908
- total_payload_bpp_mean: 0.016079989346590908
- debug_semantic_only_full_stream_bpp_mean: 0.015617601799242424
- debug_full_stream_bpp_mean: 0.025357333096590908
- semantic_only_full_stream_bpp_mean: 0.015617601799242424
- stage3_full_stream_bpp_mean: 0.025357333096590908
- semantic_payload_bytes_mean: 88.93939393939394
- detail_payload_bytes_mean: 42.78787878787879
- stage3_stream_bytes_mean: 207.72727272727272
...
- semantic_topk_hit_rate_mean: 0.6073863636363637
...
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual/per_image_metrics.jsonl

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b4_semposleft_g4_coser_common_lic_stage1_lpips002_ft500_tf384_32kprior_8192resid_pp_unsharp100_perceptual/stage3_uniform_residual_grid.png`
