# 20260627_stage1_active5k_coser_common_lic_perimage_recon

Date: 2026-06-27T17:59:17

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage1_semantic_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt --eval-protocol coser_common_lic --batch-size 4 --num-workers 4 --compute-perceptual --codec fixed_bits --write-per-image-metrics --save-reconstructions --run-name 20260627_stage1_active5k_coser_common_lic_perimage_recon
```
...
- summary: `results/bitstreams/stage1_semantic_vq/20260627_stage1_active5k_coser_common_lic_perimage_recon/summary.json`
- output_dir: `results/bitstreams/stage1_semantic_vq/20260627_stage1_active5k_coser_common_lic_perimage_recon`
- streams: ``
- reconstructions: `results/bitstreams/stage1_semantic_vq/20260627_stage1_active5k_coser_common_lic_perimage_recon/reconstructions`
- per_image_metrics: `results/bitstreams/stage1_semantic_vq/20260627_stage1_active5k_coser_common_lic_perimage_recon/per_image_metrics.jsonl`
