# 20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export

Date: 2026-06-27T17:05:14

## Command

```bash
/workspace/CoSER-DiC/.venv/bin/python scripts/eval_stage3_uniform_residual_bitstream.py --checkpoint checkpoints/stage1_semantic_vq/20260627_stage1_semantic_vq_fullshape_5k_hardvq_from_5k_ae_codeinit_vq010_usage001_l1only.pt --semantic-prior outputs/stage2_learned_entropy/20260627_stage2_learned_topk512_escape_huffman_fit_32768tokens_8kprior/learned_topk_escape_huffman_prior.json --token-prior-checkpoint checkpoints/stage2_token_prior/20260627_stage2_token_prior_tf256_l4_8kstep_32768tokens_lr1e4_do02_es.pt --eval-protocol coser_common_lic --batch-size 4 --num-workers 4 --detail-downsample-factor 32 --detail-bits 5 --detail-range 0.25 --detail-gain 1.1 --detail-codec semantic_position_leftctx_huffman --detail-prior outputs/stage3_residual_entropy/20260627_stage3_residual_semposleft_g4_sm0_d32_b5_r025_8192calib_openimages_div2k/static_residual_grid_semantic_position_leftctx_huffman_prior.json --stream-header-codec compact --stream-checksum-codec crc32 --save-reconstructions --run-name 20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export
```
...
- semantic_payload_bpp_mean: 0.01051654237689394
- detail_payload_bpp_mean: 0.007850230823863637
- actual_payload_bpp_mean: 0.018366773200757577
- paper_bpp_mean: 0.018366773200757577
- total_payload_bpp_mean: 0.018366773200757577
- debug_semantic_only_full_stream_bpp_mean: 0.01527728456439394
- debug_full_stream_bpp_mean: 0.026302083333333334
- semantic_only_full_stream_bpp_mean: 0.01527728456439394
- stage3_full_stream_bpp_mean: 0.026302083333333334
- semantic_payload_bytes_mean: 86.15151515151516
- detail_payload_bytes_mean: 64.30909090909091
- stage3_stream_bytes_mean: 215.46666666666667
- semantic_only_psnr_mean: 20.918589372345895
- semantic_only_l1_mean: 0.06731071671414555
- semantic_only_ms_ssim_mean: 0.6891293355912873
- stage3_psnr_mean: 21.39009632919774
- stage3_l1_mean: 0.06478127382526344
- stage3_ms_ssim_mean: 0.6937881059718854
- semantic_topk_hit_rate_mean: 0.6509469696969697
- semantic_token_roundtrip_mean: 1.0
- detail_code_roundtrip_mean: 1.0
- residual_grid_abs_mean_mean: 0.021033617656565074
- residual_grid_std_mean: 0.025066870132066085
- residual_grid_clip_ratio_mean: 0.0
- detail_code_entropy_bits_mean: 2.5495722131295637
- stage3_psnr_delta_vs_semantic_only: 0.47150695685184374
- stage3_l1_delta_vs_semantic_only: -0.0025294428888821135
- stage3_ms_ssim_delta_vs_semantic_only: 0.004658770380598143
- all_semantic_tokens_roundtrip: True
- all_detail_codes_roundtrip: True
- roundtrip_failure_count: 0
- roundtrip_failures: []
- per_image_metrics: results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/per_image_metrics.jsonl
- reconstruction_manifest: results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/reconstructions/manifest.jsonl
- reconstruction_count: 165
- reconstruction_dirs: {'reference': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/reconstructions/reference', 'semantic_only': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/reconstructions/semantic_only', 'stage3': 'results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/reconstructions/stage3'}

## Artifacts

- summary: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/summary.json`
- per_image_metrics: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/per_image_metrics.jsonl`
- sample: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/stage3_uniform_residual_grid.png`
- reconstruction_manifest: `results/bitstreams/stage3_uniform_residual/20260627_stage3_b5_semposleft_g4_coser_common_lic_gain110_recon_export/reconstructions/manifest.jsonl`
