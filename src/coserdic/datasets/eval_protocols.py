...
EVAL_PROTOCOLS: dict[str, EvalProtocolSpec] = {
    ...
    "cod_reproduction_512": EvalProtocolSpec(
        ...
        notes=(
            ...
            "For GenCodec public-script patch FID, run per dataset and label exact settings: Kodak512 uses 64px patches with split=2; non-Kodak datasets use 256px patches with split=2.",
            "If a legacy CoD-paper reproduction uses a different CLIC patch size, report it in a separate table with the exact patch size/backend.",
